...
vars = {
  ...
  'src_internal_revision': '0e6c74b57612f936cc6f345bbfe4654592ff0b6f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'f3b22eaf86bdefa992cb546745e32bd8b6fe681c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2975a2da016c72efb3243acf84eedd9fe085c856',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '8b1583b0fb08e2967ea9b8034a10f73b78693bfa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '97bdc453fbedee92ed0fc7687544098efc821622',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling PDFium
  # and whatever else without interference from each other.
  'pdfium_revision': '909a33cd76e7f37b7ee92100b50e2df78e398a70',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '91aa9652fe3b26e1704cd5a0f7c0dc7f3270cab4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling chromium_variations
  # and whatever else without interference from each other.
  'chromium_variations_revision': 'd548cc1dbd2cff770a5018e4db4898ca6ab82c34',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  'crossbench_revision': 'fda8bf910a70437f3334f02006a462d23920bef2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '098bf1829f67ab4a8a9dd9ef61dc125135e179af',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '80d154d57dd44830e24eb0f84bcdf95b83eb0f1c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '9c6a11eff1067aa5c789f77ce1798cffa80333df',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': 'f94d8da7f7ba8dde92cc0edd1b9699a693f90b7a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'libcxxabi_revision':    '3cede154a6799bc8a9eb0339fa2695774a300886',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'e82c3d242e04bb6fcd4169bd9e03860e9f5d8671',
    'condition': 'checkout_android and checkout_src_internal',
  },

  'src/docs/website': {
    'url': Var('chromium_git') + '/website.git' + '@' + 'e6b1323b1137fe1193360c61279b6f001028f980',
  },
    ...
    'packages': [
      {
          ...
          'version': 'WJvGTaSHCNCpZEeWzwMyZeGT_2FtDXGwqMbKoHUNxfsC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/chromite': {
      'url': Var('chromium_git') + '/chromiumos/chromite.git' + '@' + '95cbdf50c1509270f8e8e496e5d0a333d07f7340',
      'condition': 'checkout_chromeos',
  },
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b5ef7930142ce95c2bafaaa5182a47b1525c000e',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2a5d21f5fb509474ecdc63418e2f17e2bbd9fd6f',
  ...
  'src/third_party/re2/src':
    Var('chromium_git') + '/external/github.com/google/re2.git' + '@' + '6148386f0c8f03da1ab0bf982a4dbe080b4ea7bc',

  'src/third_party/r8': {
      'packages': [
          {
              'package': 'chromium/third_party/r8',
              'version': 'PyEDdX7GOndyKvm6rRXizmsJg9u1b8He2JqMNPO3F-UC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c3ff3250b9e71109b3ea06053819b9853ef5beae',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'cbc75034ebad27ca2504e30896376515bf3cc121',

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1b1f71224777a79350d4cc64154298bdc473be08',
      ...
      'packages': [
        {
          ...
          'version': 'UFlmhX6-Qb8IgDGznrPTinozgZ41Ul69CJEw_37d5Q0C',
        },
      ],
      'dep_type': 'cipd',
      'condition': 'checkout_linux',
      ...
      'packages': [
        {
          ...
          'version': 'jMrnfAAYCvmmOPZpirRZ6xWBdRaWW7g85mdjTFvq_HsC',
        },
      ],
      'dep_type': 'cipd',
      'condition': 'checkout_win',
      ...
      'packages': [
        {
          ...
          'version': 'UjktW10Ah81eMdqbYaUevQNFJozJWoGy33MmF1BdM18C',
        },
      ],
      'dep_type': 'cipd',
      'condition': 'checkout_mac',
      ...
      'packages': [
        {
          ...
          'version': 'obLm-ouXMf1S3hnZaO-yUAG5CoeW2qzVWy2fhz3WXWIC',
        },
      ],
      'dep_type': 'cipd',
      'condition': 'checkout_mac',
    ...
    'packages': [
      {
        ...
        'version': 'K04VWsf0Rpm28U0yo0AD7KnsHoID1oduKR-Fy2baMNIC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'hBJuBwWLB3jMuJNW92R9ti-vz_4yZqqRamYKjucCZj4C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': '8GhVyQfDr4ace9LWb1Ck4q6SQcmG567KH5loJqphUasC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/chrome/browser/resources/chromeos/quickoffice': {
      'url': Var('chrome_git') + '/quickoffice/crx.git' + '@' +
        'bde98615a9809b5a7fbc70faa8df8994471e852d',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'db20e4841e22de56b4ddb4fb02bf4a2ecf5a7cd2',
